...
git_path = ml_root / "intel_classification"
...
if __name__=="__main__":
    ...
    subprocess.check_call('cp -r /opt/ml/processing/intel_classification/dataset/train/* /opt/ml/processing/dataset/train', shell=True)
    subprocess.check_call('cp -r /opt/ml/processing/intel_classification/dataset/test/* /opt/ml/processing/dataset/test', shell=True)
